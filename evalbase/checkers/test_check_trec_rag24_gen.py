...
try:
    ...
    from check_trec_rag24_gen import Errlog, check_rag_gen_run
import os
import tempfile
...
class TestCheckRagGenRun(unittest.TestCase):
    ...
    def test_check_rag_gen_run_with_topic_errors(self):
        ...
        with open(error_log_file, 'r') as f:
            ...
            self.assertIn('WARNING Line 1: No response returned for topic 2024-001\n', error_log)
    ...
    def test_check_rag_gen_run_invalid_references(self):
        ...
        with open(error_log_file, 'r') as f:
            error_log = f.readlines()
            self.assertIn('ERROR Line 1: Invalid reference docno invalid_reference_1\n', error_log)
            self.assertIn('ERROR Line 1: Invalid reference docno invalid_reference_2\n', error_log)
    ...
    def test_check_rag_gen_run_response_length_mismatch(self):
        ...
        run_content = json.dumps({
            ...
            'answer': [{'text': 'This is a longer test answer.', 'citations': [0]}]
        }) + '\n'
        ...
        with open(error_log_file, 'r') as f:
            error_log = f.readlines()
            self.assertIn('WARNING Line 1: Reported RAG answer (5) is not equal to actual response length (6), maybe you did not NFCK normalize the text or strip characters?\n', error_log)
    ...
    def test_check_rag_gen_run_too_many_references(self):
        ...
        with open(error_log_file, 'r') as f:
            error_log = f.readlines()
            self.assertIn('ERROR Line 1: Duplicate document msmarco_v2.1_doc_1_1#1_1 in references\n', error_log)
    ...
    def test_check_rag_gen_run_long_answer_fixed(self):
        ...
        run_content = json.dumps({
            ...
            'answer': [{'text': 'Test answer is the best. ', 'citations': [0]}] * 90
        }) + '\n'
        ...
        with open(fixed_file, 'r') as f:
            ...
            self.assertLess(len(" ".join([sent['text'] for sent in fixed_content['answer']]).split()), 401)

        # Check the error log
        error_log_file = run_file + '.errlog'
        with open(error_log_file, 'r') as f:
            error_log = f.readlines()
            self.assertIn('WARNING Line 1: Reported response_length is too long\n', error_log)
            self.assertIn('WARNING Line 1: Attempting to fix RAG answer of length 450\n', error_log)
    ...
    def test_check_rag_gen_run_duplicate_citations_fixed(self):
        ...
        run_content = json.dumps({
            ...
            'topic_id': '2024-001',
            'topic': 'Test topic',
            'references': ['msmarco_v2.1_doc_1_1#1_1', 'msmarco_v2.1_doc_2_2#2_2'],
            'response_length': 10,
        ...
        with open(error_log_file, 'r') as f:
            error_log = f.readlines()
            self.assertIn('WARNING Line 1: Response sentence has duplicate citations\n', error_log)
    ...
    def test_check_rag_gen_run_out_of_bounds_citation_fixed(self):
        ...
        run_content = json.dumps({
            ...
            'references': ['msmarco_v2.1_doc_1_1#1_1'],
            'response_length': 10,
            'answer': [{'text': 'Test answer.', 'citations': [0, 1]}]  # 1 is out of bounds
        }) + '\n'
        ...
        with open(error_log_file, 'r') as f:
            error_log = f.readlines()
            self.assertIn('WARNING Line 1: Response sentence has a citation that is out of bounds\n', error_log)
            self.assertIn('ERROR Line 1: Response sentence has invalid citation 1\n', error_log)
    ...
    def test_check_rag_gen_run_multiple_errors_fixed(self):
        ...
        run_content = json.dumps({
            ...
            'answer': [
                {'text': 'Test answer is best.', 'citations': [0, 0, 1, 2]}] * 50 +  # Duplicate and out of bounds citations
        ...
        with open(error_log_file, 'r') as f:
            ...
            self.assertIn('WARNING Line 1: Response sentence has duplicate citations\n', error_log)
            self.assertIn('WARNING Line 1: Response sentence has a citation that is out of bounds\n', error_log)
            self.assertIn('ERROR Line 1: Response sentence has invalid citation 2\n', error_log)
