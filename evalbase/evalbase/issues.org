...
** DONE Sign an agreement
CLOSED: [2022-12-22 Thu 16:04]
...
** DONE the submitted runs display should really be elsewhere.  It also shows "Already submitted" even if there are no submissions.  And it should only show for this user, or this org, or this conference.
CLOSED: [2023-01-07 Sat 20:17]
...
** ONGOING BUG In the edit view, checkbox multiple-choices aren't completed.
